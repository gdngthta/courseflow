...
export function CourseCard({ course, stats, projectCount, nextDeadline, onEdit, onArchive, onUnarchive }: CourseCardProps) {
  ...
  return (
    <div className={`bg-slate-900 border rounded-xl p-5 flex flex-col gap-4 ${isArchived ? 'border-slate-700 opacity-70' : 'border-slate-800'}`}>
      {/* Header */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {isArchived && (
                <span className="text-xs text-slate-400 bg-slate-800 px-1.5 py-0.5 rounded">Archived</span>
              )}
            </div>
        ...
        <div className="flex items-center gap-1 flex-shrink-0">
          ...
          {isArchived ? (
            ...
            <button
              ...
              className="p-1.5 rounded-md text-slate-500 dark:text-slate-400 hover:text-amber-400 hover:bg-slate-700 transition-colors"
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-slate-800 rounded-lg p-3">
          ...
          <p className="text-lg font-bold text-white">
            {stats.incomplete}
            <span className="text-xs text-slate-400 ml-1 font-normal">to do</span>
          </p>
